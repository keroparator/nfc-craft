...
React Native ve Expo kullanılarak geliştirilmiş, NFC etiketlerini/kartlarını okuma ve farklı formatlarda veri yazma yeteneğine sahip son kullanıcı için geliştirilmiş mobil uygulamadır.
...
- **Bluetooth Eşleşmesi:** Belirtilen MAC adresi üzerinden cihazların hızlıca eşleşmesini sağlayan Out-of-Band verisi yazar.
